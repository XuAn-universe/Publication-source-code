function draw_average_locations_at_bite(ceyel_all_NI, ceyer_all_NI, cpawl_all_NI, cpawr_all_NI, ctop_all_NI, cbottom_all_NI,...
    ceyel_all_I, ceyer_all_I, cpawl_all_I, cpawr_all_I, ctop_all_I, cbottom_all_I, ID_front_NI, ID_top_NI, ID_front_I, ID_top_I, trange, i)
%*---------------------------------------------------------------------*
% Huang Lab
% Duke University
...
if ~isempty(ID_front_NI)
    plotline(ceyer_all_NI(trange+1, 1, ID_front_NI, i), ceyel_all_NI(trange+1, 1, ID_front_NI, i), ceyer_all_NI(trange+1, 3, ID_front_NI, i), ceyel_all_NI(trange+1, 3, ID_front_NI, i), [0 0 0]);
    plotline(0, ceyel_all_NI(trange+1, 1, ID_front_NI, i), 0, ceyel_all_NI(trange+1, 3, ID_front_NI, i), [0 0 0]);
    plotline(0, ceyer_all_NI(trange+1, 1, ID_front_NI, i), 0, ceyer_all_NI(trange+1, 3, ID_front_NI, i), [0 0 0]);
    
    plotline(0, cpawl_all_NI(trange+1, 1, ID_front_NI, i), 0, cpawl_all_NI(trange+1, 3, ID_front_NI, i), [0 0 0]);
    plotline(0, cpawr_all_NI(trange+1, 1, ID_front_NI, i), 0, cpawr_all_NI(trange+1, 3, ID_front_NI, i), [0 0 0]);
    ...
    ploterrorbar(ceyel_all_NI(trange+1, 1, ID_front_NI, i), ceyel_all_NI(trange+1, 3, ID_front_NI, i), [0 0 0]);
    ploterrorbar(ceyer_all_NI(trange+1, 1, ID_front_NI, i), ceyer_all_NI(trange+1, 3, ID_front_NI, i), [0 0 0]);
...
if ~isempty(ID_front_I)
    plotline(ceyer_all_I(trange+1, 1, ID_front_I, i), ceyel_all_I(trange+1, 1, ID_front_I, i), ceyer_all_I(trange+1, 3, ID_front_I, i), ceyel_all_I(trange+1, 3, ID_front_I, i), [0.8 0.8 0.8]);
    plotline(0, ceyel_all_I(trange+1, 1, ID_front_I, i), 0, ceyel_all_I(trange+1, 3, ID_front_I, i), [0.8 0.8 0.8]);
    plotline(0, ceyer_all_I(trange+1, 1, ID_front_I, i), 0, ceyer_all_I(trange+1, 3, ID_front_I, i), [0.8 0.8 0.8]);
    
    plotline(0, cpawl_all_I(trange+1, 1, ID_front_I, i), 0, cpawl_all_I(trange+1, 3, ID_front_I, i), [0.8 0.8 0.8]);
    plotline(0, cpawr_all_I(trange+1, 1, ID_front_I, i), 0, cpawr_all_I(trange+1, 3, ID_front_I, i), [0.8 0.8 0.8]);
    ...
    ploterrorbar(ceyel_all_I(trange+1, 1, ID_front_I, i), ceyel_all_I(trange+1, 3, ID_front_I, i), [0.8 0.8 0.8]);
    ploterrorbar(ceyer_all_I(trange+1, 1, ID_front_I, i), ceyer_all_I(trange+1, 3, ID_front_I, i), [0.8 0.8 0.8]);
...
if ~isempty(ID_top_NI)
    plotline(ceyer_all_NI(trange+1, 1, ID_top_NI, i), ceyel_all_NI(trange+1, 1, ID_top_NI, i), ceyer_all_NI(trange+1, 2, ID_top_NI, i), ceyel_all_NI(trange+1, 2, ID_top_NI, i), [0 0 0]);
    plotline(0, ceyel_all_NI(trange+1, 1, ID_top_NI, i), 0, ceyel_all_NI(trange+1, 2, ID_top_NI, i), [0 0 0]);
    plotline(0, ceyer_all_NI(trange+1, 1, ID_top_NI, i), 0, ceyer_all_NI(trange+1, 2, ID_top_NI, i), [0 0 0]);
    
    plotline(0, cpawl_all_NI(trange+1, 1, ID_top_NI, i), 0, cpawl_all_NI(trange+1, 2, ID_top_NI, i), [0 0 0]);
    plotline(0, cpawr_all_NI(trange+1, 1, ID_top_NI, i), 0, cpawr_all_NI(trange+1, 2, ID_top_NI, i), [0 0 0]);
    ...
    ploterrorbar(ceyel_all_NI(trange+1, 1, ID_top_NI, i), ceyel_all_NI(trange+1, 2, ID_top_NI, i), [0 0 0]);
    ploterrorbar(ceyer_all_NI(trange+1, 1, ID_top_NI, i), ceyer_all_NI(trange+1, 2, ID_top_NI, i), [0 0 0]);
...
% inhibition data
if ~isempty(ID_top_I)
    plotline(ceyer_all_I(trange+1, 1, ID_top_I, i), ceyel_all_I(trange+1, 1, ID_top_I, i), ceyer_all_I(trange+1, 2, ID_top_I, i), ceyel_all_I(trange+1, 2, ID_top_I, i), [0.8 0.8 0.8]);
    plotline(0, ceyel_all_I(trange+1, 1, ID_top_I, i), 0, ceyel_all_I(trange+1, 2, ID_top_I, i), [0.8 0.8 0.8]);
    plotline(0, ceyer_all_I(trange+1, 1, ID_top_I, i), 0, ceyer_all_I(trange+1, 2, ID_top_I, i), [0.8 0.8 0.8]);
    
    plotline(0, cpawl_all_I(trange+1, 1, ID_top_I, i), 0, cpawl_all_I(trange+1, 2, ID_top_I, i), [0.8 0.8 0.8]);
    plotline(0, cpawr_all_I(trange+1, 1, ID_top_I, i), 0, cpawr_all_I(trange+1, 2, ID_top_I, i), [0.8 0.8 0.8]);
    ...
    ploterrorbar(ceyel_all_I(trange+1, 1, ID_top_I, i), ceyel_all_I(trange+1, 2, ID_top_I, i), [0.8 0.8 0.8]);
    ploterrorbar(ceyer_all_I(trange+1, 1, ID_top_I, i), ceyer_all_I(trange+1, 2, ID_top_I, i), [0.8 0.8 0.8]);
