...
%*---------------------------------------------------------------------*
%%
exp_path = {'I:\Videos for head fixed stimulation DLC tracking\20180405_Laser(Fezf2Ai32 TSP27)\exp001'};
pre = 0.5;
exc_path = 0; % specify folder, 1 for exp001, 2 for exp002 etc.
excID = [0:381 1891]; % remove these trials, not use them to compute
FrameRate = 100;
nbins = 2000;
body_check = 1; % 1 left forelimb, 2 right forelimb, 3 jaw
